  ...
  DT::datatable(
    ...
    options = list(
      ...
      columnDefs = list(
        list(
          visible = FALSE,
          targets = c(1, 11, 14, 15, 18, 19, 21:23, 27, 31, 32, 33, 34, 35, 36) # hide columns
        )
      ),
      buttons = list(
...
p <- plot_ly(shared_metadata,
  x = ~PC1, y = ~PC2, z = ~PC3, color = cgroups, colors = cpalette, hoverinfo = "text", marker = list(size = 8),
  text = ~ paste(
    "</br><b> Sample: ", Sample, "</br> Flowcell Lanes: ", flowcell_lanes, "</br> medTIN: ", median_tin, "</b></br></br> % Aligned: ", percent_aligned,
...
p <- plot_ly(shared_metadata,
  x = ~PC1_tin, y = ~PC2_tin, z = ~PC3_tin, color = cgroups, colors = cpalette, hoverinfo = "text", marker = list(size = 8),
  text = ~ paste(
    "</br><b> Sample: ", Sample, "</br> Flowcell Lanes: ", flowcell_lanes, "</br> medTIN: ", median_tin, "</b></br></br> % Aligned: ", percent_aligned,
...
g <- ggplot(multiQC, aes(PC1, PC2, color = TissueType), xlab) +
  geom_point(size = multiQC$TissueType) +
  theme_minimal() +
